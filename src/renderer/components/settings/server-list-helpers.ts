...
import { getCountryCode } from './flag-detect';
...
// 节点名 → 国家/地区 alpha-2 检测单一真值：下沉 flag-detect（数据驱动 74 区域 + emoji 通用解码）。
// 保留本文件的 getCountryCode 导出路径（既有 import 与单测不受影响）；旧 23 分支硬编码已退役。
