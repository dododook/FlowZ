...
const MESSAGES = {
  ...
  // —— App 更新弹窗（独立 mini 更新窗，UpdateService.createUpdatePopup；四态标题/文案/按钮） ——
  updRemindTitle: {
    'zh-CN': '发现新版本',
    'zh-TW': '發現新版本',
  ...
  updProgressTitle: {
    ...
    fa: 'در حال دانلود به‌روزرسانی',
  },
  updDoneTitle: {
    'zh-CN': '下载完成',
    'zh-TW': '下載完成',
    'en-US': 'Download complete',
  ...
  updInstalling: {
    'zh-CN': '下载完成，正在安装…',
    'zh-TW': '下載完成，正在安裝…',
    'en-US': 'Downloaded, installing…',
    ru: 'Загружено, установка…',
    fa: 'دانلود شد، در حال نصب…',
  },
  updTryingMirror: {
    'zh-CN': '正在尝试通过镜像下载…',
    'zh-TW': '正在嘗試透過鏡像下載…',
    'en-US': 'Trying mirror…',
    ru: 'Попытка через зеркало…',
    fa: 'تلاش از طریق سرور آینه…',
  },
  updBtnUpdate: {
    'zh-CN': '立即更新',
    'zh-TW': '立即更新',
  ...
  updBtnManualDownload: {
    'zh-CN': '手动下载',
    'zh-TW': '手動下載',
    'en-US': 'Download manually',
    ru: 'Скачать вручную',
    fa: 'دانلود دستی',
  },
  updBtnClose: {
