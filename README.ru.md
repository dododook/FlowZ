...
1. **Добавьте узел** — выберите протокол на странице «Серверы» или импортируйте ссылку подписки в разделе «Подписки».
